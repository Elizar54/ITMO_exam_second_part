...
P.S.: эта ветка содержит не совсем корректную реализацию. После завершения экзамена автор предпринял попытку скорректировать код решения. Его можно найти в ветке after_exam_correction, но автор понимает, что организаторы не обязаны и не должны смотреть те изменения, которые были сделаны после завершения экзамена. Просто ему самому захотелось доработать решение. 
